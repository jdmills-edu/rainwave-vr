...
hidePartyMeshes = [carpet, speakerLeft, speakerRight, cone1Left, cone2Left, cone1Right, cone2Right, controlPanel, allButton.mesh, gameButton.mesh, chipButton.mesh, ocrButton.mesh, coversButton.mesh, stopCylinder, stopSquare, instructionsText, helpButton, helpCylinder];

//leap motion hand menu
//toggle
geometry = new THREE.BoxGeometry(5, 3, 5);
material = new THREE.MeshBasicMaterial({color:'#f7941e'});
var leapMenuToggle = new THREE.Mesh(geometry, material);
thisObject = leapMenuToggle;
thisObject.name = "leapMenuToggle";
thisObject.position.z = 6;
thisObject.position.y = 2;
thisObject.visible = false;
scene.add(thisObject);
...
var leapLaserButton = new THREE.Mesh(geometry, material);
thisObject = leapLaserButton;
thisObject.name = "leapLaserButton";
thisObject.position.z = 8;
thisObject.visible = false;
scene.add(thisObject);
...
geometry = new THREE.BoxGeometry(4, 1, 4);
material = new THREE.MeshBasicMaterial({color:'#1f95e5'});
var leapVolumeToggle = new THREE.Mesh(geometry, material);
thisObject = leapVolumeToggle;
thisObject.name = "leapVolumeToggle";
thisObject.position.z = 8;
...
geometry = new THREE.BoxGeometry(4, 1, 4);
material = new THREE.MeshBasicMaterial({color:'#1f95e5'});
var leapElection = new THREE.Mesh(geometry, material);
thisObject = leapElection;
thisObject.name = "leapElection";
thisObject.position.z = 8;
thisObject.visible = false;
scene.add(thisObject);

var leapMenuObjects = [leapLaserButton, leapVolumeToggle, leapElection];

//lasers!
//left
geometry = new THREE.BoxGeometry(1, 1, 800);
material = new THREE.MeshBasicMaterial({color:'#1f95e5'});
var leftLaser = new THREE.Mesh(geometry, material);
thisObject = leftLaser;
thisObject.name = "leftLaser";
thisObject.position.z = 404;
thisObject.visible = false;
scene.add(thisObject);
...
geometry = new THREE.BoxGeometry(1, 1, 800);
material = new THREE.MeshBasicMaterial({color:'#1f95e5'});
var rightLaser = new THREE.Mesh(geometry, material);
thisObject = rightLaser;
thisObject.name = "rightLaser";
thisObject.position.z = 404;
thisObject.visible = false;
scene.add(thisObject);